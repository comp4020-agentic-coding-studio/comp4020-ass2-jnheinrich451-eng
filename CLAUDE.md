...
## Prose
Week page bodies are written by hand. Do not draft, rewrite, expand,
summarise or "improve" the body text of any week page. You may fix
frontmatter, markup and formatting.
