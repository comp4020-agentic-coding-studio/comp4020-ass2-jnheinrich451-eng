...
import PaperSlide from "../components/PaperSlide.astro";
import "./week-02-template.css";

<DeckExit back="/lectures/week-02/" label="Week 02" />

{/* _class: paper-slide paper-lecture paper-opening paper-slide--1 */}

<PaperSlide title="Two Gaussians, one number." index={1} total={17} variant="opening">
...
```notes
- seventeen slides, one derivation, then one hinge
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--2 */}

<PaperSlide title="The number we are trying to explain" index={2} total={17} variant="teaching">
...
<p class="small">Covariance describes spread and correlation, not arbitrary distribution shape.</p>
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--3 */}

<PaperSlide title="FID does not compare images" index={3} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--4 */}

<PaperSlide title="Same marginals. Different couplings." index={4} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--5 */}

<PaperSlide title="Wasserstein as a search" index={5} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--6 */}

<PaperSlide title="Why this is hard" index={6} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--7 */}

<PaperSlide title="Start in one dimension" index={7} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--8 */}

<PaperSlide title="Two things are being measured" index={8} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--9 */}

<PaperSlide title="Now go to d dimensions" index={9} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--10 */}

<PaperSlide title="The derivation board" index={10} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--11 */}

<PaperSlide title="The problem has collapsed" index={11} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--12 */}

<PaperSlide title="The Gaussian solution" index={12} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--13 */}

<PaperSlide title="FID adds an instrument" index={13} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--14 */}

<PaperSlide title="Why people believed the number" index={14} total={17} variant="teaching">
...
<p class="label">Schematic trends, not measured values · original experiment identified in speaker notes</p>
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--15 */}

<PaperSlide title="Four assumptions enter the number" index={15} total={17} variant="teaching">
...
{/* _class: paper-slide paper-lecture paper-teaching paper-slide--16 */}

<PaperSlide title="Which model is closer?" index={16} total={17} variant="teaching">

Reference R, candidates A and B, scored by the closed form rather than by
sampling.

<div class="split">
  <div class="bench-case"><p class="label">A / mean shift</p><Eq name="bench-a" alt="W-2 squared of R and A equals 5.12." /><p class="small">2,048 × 0.05²</p></div>
  <div class="bench-case"><p class="label">B / wider spread</p><Eq name="bench-b" alt="W-2 squared of R and B is approximately 4.88." /><p class="small">2,048 × (√1.1 − 1)²</p></div>
</div>
...
{/* _class: paper-slide paper-lecture paper-ending paper-slide--17 */}

<PaperSlide title="The distance is clean. The instrument is not." index={17} total={17} variant="ending">
